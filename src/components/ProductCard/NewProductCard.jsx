...
const NewProductCard = ({product}) => {
    ...
    return (
           <div
            className="bg-white border border-gray-200 max-w-sm shadow-sm overflow-hidden 
                 rounded-2xl hover:border-[#fcab35] transition-all relative"
        >
            <div className="">
                <div
                    className="aspect-281/218 text-center bg-gray-50 overflow-hidden 
