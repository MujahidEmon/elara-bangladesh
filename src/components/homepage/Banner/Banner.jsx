      ...
      >
        {adminSlides.map((slide) => (
          <SwiperSlide key={slide._id}>
            <div
              className="md:max-w-full rounded-sm max-w-sm mx-auto md:h-[500px] h-90 bg-cover bg-center flex flex-col md:items-start items-center justify-center gap-8 md:p-10 p-6"
